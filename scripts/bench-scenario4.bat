...
REM -- Scenario 4: POST /echo  |  256-byte JSON body  |  c=100  |  n=100000 ------
REM bench-plan.md Sec.Scenarios row 4
REM
REM Exercises the body read + write path: pool shadow-field hot path,
REM FBodyString cache, and the async write-completion chain.
...
REM 256-byte JSON body: {"data":"<245 x A>"} = 9 + 245 + 2 = 256 bytes
set BODY={"data":"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"}

set OPTS=--print r --latencies --http1 -m POST -b "%BODY%" -H "Content-Type: application/json"
...
echo.
echo ================================================================================
echo  Scenario 4 - POST /echo   256-byte JSON body   c=%CONCURRENCY%   n=%REQUESTS%
echo ================================================================================
